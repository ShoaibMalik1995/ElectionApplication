<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="AdminVideo.aspx.cs" Inherits="AdminVideo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="winning-candidate">
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ElecConnection %>" SelectCommand="GetLastFiveVideoResults1" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="NAId" QueryStringField="NAId" Type="Int32" />
                <asp:QueryStringParameter Name="PAId" QueryStringField="PAId" Type="Int32" />
                <asp:QueryStringParameter Name="Type" QueryStringField="Type" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
          <asp:DataList ID="DataList1" runat="server" BorderStyle="Double" BorderWidth="2" DataSourceID="SqlDataSource1">
            <ItemTemplate>
                <table class="auto-style1">
                    <tr  style="border:double;border-color:burlywood">
                        <td   style="border:double;border-color:burlywood;width:5%"  >                        <asp:Label ID="lbl1" runat="server" Text='<%# Eval("ElectionYear") %>'></asp:Label></td>
                        <td  style="border:double;border-color:burlywood" >                           <asp:Literal ID="Literal2" runat="server" Text='<%# Eval("Winner1") %>'></asp:Literal></td>
                        <td  style="border:double;border-color:burlywood" >                           <asp:Literal ID="Literal3" runat="server" Text='<%# Eval("Winner2") %>'></asp:Literal></td>
                        <td  style="border:double;border-color:burlywood" >                           <asp:Literal ID="Literal4" runat="server" Text='<%# Eval("Winner3") %>'></asp:Literal></td>
                        <td  style="border:double;border-color:burlywood" >                           <asp:Literal ID="Literal5" runat="server" Text='<%# Eval("Winner4") %>'></asp:Literal></td>
                        <td  style="border:double;border-color:burlywood" >                           <asp:Literal ID="Literal6" runat="server" Text='<%# Eval("Winner5") %>'></asp:Literal></td>
                    </tr>
      <%--              <tr>
