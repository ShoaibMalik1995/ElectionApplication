...
public partial class Reports_DepartmentalAnalyzingSummary : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
                ...
                List<SqlParameter> parm = new List<SqlParameter>
            {
                ...
                DataTable dt = null;
                 ...
                 dt=  ObjDBManager.ExecuteDataTable("GetLastFiveElection_DepartmentalAnalysis", parm);
                   // ObjDBManager.ExecuteDataDatbe("GetDepartmentalAnalyzerNANA", parm);
