...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="summary-links-na">
        <nav id="fh5co-menu-wrap" role="navigation" style="width: 100%;margin: 0;padding-top: 10px;">
            <ul class="sf-menu summary-li" id="fh5co-primary-menu" style="padding: 0;height: 37px;line-height: 0px;width: 100%;">
                ...
                <li  style="margin:0 5%;">
                    <a href="#" class="fh5co-sub-ddown">Analysis</a>
    ...
    <div style="width:100%;float:left;    margin-top: 10px;">
    <div class="summary-links-pa">
        <nav id="fh5co-menu-wrap" role="navigation">
            
            <ul class="sf-menu" id="fh5co-primary-menu"  style="padding: 0;height: 37px;line-height: 0px;">
                <li style="line-height: 40px;color:darkblue;font-weight: bold;    font-size: 24px;">Affiliated PPs:</li>                
                        <asp:datalist id="ddlList" runat="server" repeatdirection="Horizontal">
                <ItemTemplate>
                    <li style="line-height: 15px;">
                    <a href="services.html" class="fh5co-sub-ddown"><asp:Label ID="lblPaName" runat="server" Text='<%#Bind("Name") %>'></asp:Label></a>
                    <ul class="fh5co-sub-menu">
                         <li style="cursor:pointer;">
                            <asp:hyperlink id="hpStatisticsPA" runat="server" target="_blank" NavigateUrl='<%# String.Format("../Reports/NAStat.aspx?NAId={0}&Type=PA", Eval("PAId"))%>' text="Statistics"></asp:hyperlink>
                        </li>
                         <li style="cursor:pointer;">
                            <asp:hyperlink id="hpAssesmentPA" runat="server" target="_blank" NavigateUrl='<%# String.Format("../Reports/AssessmentReport.aspx?NAId={0}&PAId={1}&Type=PA", Eval("NAId"), Eval("PAId"))%>' text="Assesment"></asp:hyperlink>
                        </li>

                     <li style="cursor:pointer;">
                            <asp:hyperlink id="hpDAnalysisPA" runat="server" target="_blank" NavigateUrl='<%# String.Format("../Reports/DepartmentalAnalyzingSummary.aspx?NAId={0}&PAId={1}&Type=PA", Eval("NAId"), Eval("PAId"))%>' text="Departmental Analysis"></asp:hyperlink>
                        </li>
                        <li style="cursor:pointer;">
                            <asp:hyperlink id="hpFAnalysisPA" runat="server" target="_blank" NavigateUrl='<%# String.Format("../Reports/FafenSummaryReport.aspx?NAId={0}&PAId={1}&Type=PA", Eval("NAId"), Eval("PAId"))%>' text="Fafen / Other Analysis"></asp:hyperlink>
                        </li>
                        <li style="cursor:pointer;">
                            <asp:hyperlink id="hpVAnalysisPA" runat="server" target="_blank" NavigateUrl='<%# String.Format("../AdminVideo.aspx?NAId={0}&PAId={1}&Type=PA", Eval("NAId"), Eval("PAId"))%>' text="Video Analysis"></asp:hyperlink>
                        </li>
                        <li style="cursor:pointer;">
                            <asp:hyperlink id="hpPAnalysis" runat="server" target="_blank" NavigateUrl='<%# String.Format("../Reports/PartiesAnalysis.aspx?NAId={0}&PAId={1}&Type=PA", Eval("NAId"), Eval("PAId"))%>' text="Parties Analysis"></asp:hyperlink>
                        </li>                   
                         </ul>
                </li>
                </ItemTemplate>
        ...
        <asp:gridview id="grdWinningCandidates" cssclass="table-bordered table-striped" autogeneratecolumns="false" runat="server" width="100%" onrowdatabound="grdWinningCandidates_RowDataBound">
            <Columns>
                <asp:TemplateField HeaderText="Year">
                    <ItemTemplate>
                        <asp:Label ID="lblYear" style="font-size: 20px;" runat="server" Text='<%#Bind("ElectionYear") %>'></asp:Label>
                    </ItemTemplate>
