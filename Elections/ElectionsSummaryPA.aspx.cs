...
public partial class Elections_ElectionsSummary : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            hpStatistics.NavigateUrl = "~/Reports/NAStat.aspx?NAId=" + Request.QueryString["PAId"] + "&Type=PA";
            hpAssesment.NavigateUrl = "~/Reports/AssessmentReport.aspx?NAId=" + Request.QueryString["NAId"] + "&PAId=" + Request.QueryString["PAId"] + "&Type=PA";

            hpDepartmentalAnalysis.NavigateUrl = "~/Reports/DepartmentalAnalyzingSummary.aspx?NAId=" + Request.QueryString["NAId"] + "&PAId=" + Request.QueryString["PAId"] + "&Type=PA";
            hpFafenAnalysis.NavigateUrl = "~/Reports/FafenSummaryReport.aspx?NAId=" + Request.QueryString["NAId"] + "&PAId=" + Request.QueryString["PAId"] + "&Type=PA";
            hpVideoAnalysis.NavigateUrl = "~/AdminVideo.aspx?NAId=" + Request.QueryString["NAId"] + "&PAId=" + Request.QueryString["PAId"] + "&Type=PA";
            hpPartyAnalysis.NavigateUrl = "~/Reports/PartiesAnalysis.aspx?NAId=" + Request.QueryString["NAId"] + "&PAId=" + Request.QueryString["PAId"] + "&Type=PA";
